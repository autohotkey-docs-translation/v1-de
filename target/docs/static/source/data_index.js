indexData = [
  ...
  ["<>","Variables.htm#equal",4],
  ["=","Variables.htm#equal",4],
  ["= (altmodische Zuweisung)","lib/SetEnv.htm",4],
  ["==","Variables.htm#equal",4],
  [">","Variables.htm#compare",4],
  [">=","Variables.htm#compare",4],
  [">>","Variables.htm#bitwise",4],
  ...
  ["__Handle-Eigenschaft (File)","lib/FileObj.htm#__Handle",8],
  ...
  ["AtEOF-Eigenschaft (File)","lib/FileObj.htm#AtEOF",8],
  ...
  ["Bind-Methode (Func)","lib/FuncObj.htm#Bind",8],
  ...
  ["Button-Status","lib/GetKeyState.htm#function"],
  ["ByRef","Functions.htm#ByRef",4],
  ["Caching (Konzepte)","Concepts.htm#caching"],
  ["Call-Methode (Func)","lib/FuncObj.htm#Call",8],
  ...
  ["Close-Methode (File)","lib/FileObj.htm#Close",8],
  ...
  ["copy folder/directory","lib/FileCopyDir.htm"],["Kopieren eines Ordners/Verzeichnisses","lib/FileCopyDir.htm"],
  ...
  ["create folder/directory","lib/FileCreateDir.htm"],["Erstellen eines Ordners/Verzeichnisses","lib/FileCreateDir.htm"],
  ...
  ["Drag & Drop (GUI-Fenster)","lib/Gui.htm#GuiDropFiles"],
  ...
  ["Encoding-Eigenschaft (File)","lib/FileObj.htm#Encoding",8],
  ...
  ["Enumerator-Objekt","lib/EnumeratorObj.htm"],
  ...
  ["Floating-Point (ob es dies ist)","lib/IfIs.htm"],
  ...
  ["Handle-Eigenschaft (File)","lib/FileObj.htm#Handle",8],
  ...
  ["If (altmodisch)","lib/IfEqual.htm"],
  ["If Var [not] between Niedrig and Hoch","lib/IfBetween.htm"],
  ...
  ["Integer (ob es dies ist)","lib/IfIs.htm"],
  ["Integer (Format)","lib/Format.htm"],
  ["Interrupt (Thread)","lib/Thread.htm#Interrupt",7],
  ["IsBuiltIn-Eigenschaft (Func)","lib/FuncObj.htm#IsBuiltIn",8],
  ["IsByRef-Methode (Func)","lib/FuncObj.htm#IsByRef",8],
  ["IsByRef()","lib/IsByRef.htm",2],
  ["IsFunc()","lib/IsFunc.htm",2],
  ["IsLabel()","lib/IsLabel.htm",2],
  ["IsObject()","lib/IsObject.htm",2],
  ["IsOptional-Methode (Func)","lib/FuncObj.htm#IsOptional",8],
  ["IsSet()","lib/IsSet.htm",2],
  ["IsVariadic-Eigenschaft (Func)","lib/FuncObj.htm#IsVariadic",8],
  ...
  ["key state","lib/GetKeyState.htm#function"],["Tastenstatus","lib/GetKeyState.htm#function"],
  ...
  ["Length-Eigenschaft (File)","lib/FileObj.htm#Length",8],
  ...
  ["MaxParams-Eigenschaft (Func)","lib/FuncObj.htm#MaxParams",8],
  ...
  ["MinParams-Eigenschaft (Func)","objects/FuncObj.htm#MinParams",8],
  ...
  ["move folder/directory","lib/FileMoveDir.htm"],["Verschieben eines Ordners/Verzeichnisses","lib/FileMoveDir.htm"],
  ...
  ["Pos-Eigenschaft (File)","lib/FileObj.htm#Seek",8],
  ...
  ["RawRead-Methode (File)","lib/FileObj.htm#RawRead",8],
  ["RawWrite-Methode (File)","lib/FileObj.htm#RawWrite",8],
  ["read file","lib/FileRead.htm"],["Lesen einer Datei","lib/FileRead.htm"],
  ["Read-Methode (File)","lib/FileObj.htm#Read",8],
  ["ReadLine-Methode (File)","lib/FileObj.htm#ReadLine",8],
  ["ReadNumType-Methode (File)","lib/FileObj.htm#ReadNum",8],
  ...
  ["Skripte","Scripts.htm"],
  ["Seek-Methode (File)","lib/FileObj.htm#Seek",8],
  ...
  ["Tell-Methode (File)","lib/FileObj.htm#Tell",8],
  ...
  ["Write-Methode (File)","lib/FileObj.htm#Write",8],
  ["WriteLine-Methode (File)","lib/FileObj.htm#WriteLine",8],
  ["WriteNumType-Methode (File)","lib/FileObj.htm#WriteNum",8],
