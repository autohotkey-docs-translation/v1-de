; Bildschirmtastatur (benˆtigt XP/2k/NT) -- von Jon
...
; ohne dabei auf die Tastatur zu schauen.  Die Grˆﬂe der Bildschirmtastatur
; kann im oberen Bereich des Scripts angepasst werden. Auﬂerdem kann
; die Tastatur angezeigt oder versteckt werden, wenn das Tray-Icon doppelt angeklickt wird.

;---- Konfigurationsbereich: Die Grˆﬂe der Bildschirmtastatur und
; andere Optionen anpassen.

; Beim Ver‰ndern der Schriftgrˆﬂe wird die gesamte Bildschirmtastatur
; grˆﬂer oder kleiner:
k_FontSize = 10
...
;---- Ende des Konfigurationsbereichs.  Hier danach keine ƒnderungen durchf¸hren,
...
;---- Abmessungen der Objekte berechnen, basierend auf der ausgew‰hlten Schriftgrˆﬂe:
...
Loop
{
	...
	if k_char not in <,>,^,~,Å,`,
		...
		; ob der Benutzer die Modifikatortasten wie Steuerung und Umschalt gedr¸ckt h‰lt.
	if k_ASCII = 93
		break
	k_ASCII++
}
...
; w¸rde "Shift" beim Loslassen der Taste standardm‰ﬂig ausgef¸hrt (in ‰lteren AHK-Versionen):
~*LShift::
~*RShift::
