...
function WriteOpenFooter(prefix) {
  var ss = '<div id="end">'
          ...
          +'<ul>'
          +'<li><a href="http://www.autohotkey.com/board/index.php?showforum=63">Support</a></li>'
          +'<li><a href="http://www.autohotkey.com/board/index.php?showforum=64">Scripts</a></li>'
          +'<li><a href="http://www.autohotkey.com/board/index.php?showforum=51">Vorschl&auml;ge</a></li>'
          +'<li><a href="http://www.autohotkey.com/board/index.php?showforum=53">Ank&uuml;ndigungen</a></li>'
          +'</ul>'
          +'</article>'
          +'<article>'
          +'<h4>Dokumentation</h4>'
